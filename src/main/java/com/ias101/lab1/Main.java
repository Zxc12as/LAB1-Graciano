...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        // Validate user input before sending to Authenticator
        if (!isValidUsername(credentials[0]) || !isValidPassword(credentials[1])) {
            System.err.println("Invalid username or password format. Please try again.");
    ...
    private static boolean authenticateUser(String username, String password) {
        // Escape single quotes to prevent SQL injection attempts
    ...
    private static void handleSearchUser() {
        ...
        // Validate username before searching
    ...
    private static void handleDeleteUser() {
        ...
        String username = scanner.next();
        // Validate username before deleting
        if (!isValidUsername(username)) {
            System.err.println("Invalid username format.");
            return;
        }
